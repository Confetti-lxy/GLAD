...
def run_training(args, script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 precision='fp16', use_lmdb=False, script_name_prv=None, config_name_prv=None, stage1_model=None):
    ...
    settings.tensorboard_save_dir = save_dir
    ...
    expr_module = importlib.import_module('lib.train.train_script_ds')
...
def main():
    ...
    if os.environ['WORLD_SIZE'] != 1:
        ...
        args.local_rank = -1
    run_training(args, args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 local_rank=args.local_rank, save_dir=args.save_dir, base_seed=args.seed, precision=args.precision,
