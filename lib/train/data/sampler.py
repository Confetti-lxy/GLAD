    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                # Get text information from different dataset
                if dataset.get_name() == "got10k":
                    text = f"An image of {meta_obj_test.get('root_class')}, {meta_obj_test.get('major_class')}, {meta_obj_test.get('object_class_name')}, {meta_obj_test.get('motion_class')}, {meta_obj_test.get('motion_adverb')}"
                elif dataset.get_name() == "lasot" or dataset.get_name() == "otb99_lang" or dataset.get_name() == "tnl2k" or dataset.get_name() == "refcocog" or dataset.get_name() == "vasttrack_test":  # "lasot", "otb99_lang", "tnl2k", "refcocog"
                    text = template_anno['nlp'][0]
                elif dataset.get_name() == "trackingnet":
                    text = f"An image of {meta_obj_test.get('object_class_name')}"
                elif dataset.get_name() == "coco":
                    text = f"An image of {meta_obj_test.get('object_class_name', '')}, {meta_obj_test.get('major_class', '')}"
                else:
                    raise Exception(f"Invalid Dataset {dataset.get_name()}")
                ...
                if str(e) != "worng change str to int":
                    print(e)
                    import traceback
                    traceback.print_exc()
                valid = False
