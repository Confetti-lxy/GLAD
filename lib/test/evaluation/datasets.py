...
dataset_dict = dict(
    ...
    mgit=DatasetInfo(module=pt % "videocube", class_name="VideoCubeDataset", kwargs=dict(version="tiny")),
    videocubedataset=DatasetInfo(module=pt % "videocube", class_name="VideoCubeDataset", kwargs=dict(version="full"))
)
