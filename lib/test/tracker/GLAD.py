...
class GLAD(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        if params.seed != None:
            ...
            print('Set seed to {}.'.format(params.seed))
        else:
        ...
        # motion constrain for CENTER head
        if self.cfg.TEST.SEARCH_SIZE == 336:
            self.feat_sz = self.cfg.TEST.SEARCH_SIZE // 14
        else:
    ...
    def initialize(self, image, info: dict):
        # forward the template and text once
